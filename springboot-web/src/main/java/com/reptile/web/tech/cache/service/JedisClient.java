...
public class JedisClient {
	...
	static {
		...
		LoggerFactory.getLogger(JedisClient.class).debug("redis配置文件读取完成,服务器地址: ---  //"+proper.getProperty("redis.host"));
		...
		LoggerFactory.getLogger(JedisClient.class).debug("JedisClient及JedisPool初始化成功");
